...
{
    public static class DynamicDataReactiveListExtensions
    {
        /// <summary>
                                        ...
                                        case NotifyCollectionChangedAction.Replace:
                                            {
                                                return changes.NewItems.OfType<T>()
                                                    .Select((t, idx) =>
                                                    {
                                                        ...
                                                        return new Change<T>(ListChangeReason.Replace, t, (T)old, idx + changes.OldStartingIndex, idx + changes.OldStartingIndex);
                                                    });
                                            }
        ...
        public static IObservable<IChangeSet<TObject, TKey>> ToObservableChangeSetNew<TObject, TKey>(this ReactiveList<TObject> source, Func<TObject, TKey> keySelector)
        {
